...
function DesktopSideNav() {
  ...
  const [ selectedNav, setSelectedNav ] = useState([
    ...
    { label:"intro", value: Object.values(params)[0] === 'basics' ? true : false},
    { label:"headneck", value: Object.values(params)[0] === 'headneck' ? true : false},
    { label:"torso", value: Object.values(params)[0] === 'torso' ? true : false},
    { label:"upperextremities", value: Object.values(params)[0] === 'upperextremities' ? true : false},
    { label:"lowerextremities", value: Object.values(params)[0] === 'lowerextremities' ? true : false},
  ])
  ...
  return (
    <div id="desktopSideNav">
      <div className="desktopSideNav--wrapper smallText">
        ...
        <Link to='/' onClick={() => sideNavSelectToggle({selectedNav, setSelectedNav})('one')} className={`desktopSideNav--item desktopSideNav--itemOne ${selectedNav[0].value === true ? 'sideNavActive' : 'sideNavInactive'}`}>
          <CabinRoundedIcon />
          <p>Home</p>
        </Link>
        {/* Home sub nav */}
        ...
        <Link to='/list' onClick={() => sideNavSelectToggle({selectedNav, setSelectedNav})('three')} className={`desktopSideNav--item desktopSideNav--itemThree ${selectedNav[2].value === true ? 'sideNavActive' : 'sideNavInactive'}`}>
          <SearchRoundedIcon />
          <p>Search</p>
        </Link>

        <Link to='/info' onClick={() => sideNavSelectToggle({selectedNav, setSelectedNav})('four')}  className={`desktopSideNav--item desktopSideNav--itemFour ${selectedNav[3].value === true ? 'sideNavActive' : 'sideNavInactive'}`}>
          <HelpOutlineIcon />
          <p>Info</p>
        </Link>
      </div>

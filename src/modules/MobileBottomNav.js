    ...
    <div id="mobileBottomNav">
      <div className="mobileBottomNav--wrapper smallText">
        <Link
          to="/"
          onClick={() =>
            bottomNavSelectToggle({ selectedNav, setSelectedNav })("one")
          }
          className={`mobileBottomNav--item mobileBottomNav--itemOne ${
            selectedNav[0].value === true
              ? "bottomNavActive"
              : "bottomNavInactive"
          }`}
        >
        ...
        <Link
          to="/basics"
          onClick={() =>
            bottomNavSelectToggle({ selectedNav, setSelectedNav })("two")
          }
          className={`mobileBottomNav--item mobileBottomNav--itemTwo ${
            selectedNav[1].value === true
              ? "bottomNavActive"
              : "bottomNavInactive"
          }`}
        >
        ...
        <Link
          to="/list"
          onClick={() =>
            bottomNavSelectToggle({ selectedNav, setSelectedNav })("three")
          }
          className={`mobileBottomNav--item mobileBottomNav--itemThree ${
            selectedNav[2].value === true
              ? "bottomNavActive"
              : "bottomNavInactive"
          }`}
        >
        ...
        <Link
          to="/last"
          onClick={() =>
            bottomNavSelectToggle({ selectedNav, setSelectedNav })("four")
          }
          className={`mobileBottomNav--item mobileBottomNav--itemFour ${
            selectedNav[3].value === true
              ? "bottomNavActive"
              : "bottomNavInactive"
          }`}
        >

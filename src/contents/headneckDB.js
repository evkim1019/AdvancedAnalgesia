const headneckDB = [
...

  {
    ...
    indications: {
      title: "Indications",
      content: ["1.	Lacerations and abscess of the inferior and posterior portions of the auricle"]
    },
    contraindications: [
      {
        title: "",
        content: ["1.	Allergy to local anesthetic", "2.	Infection, abscess over site of injection"]
      }
    ],
    positioning: {
      title: "Patient Positioning",
    ...
    procedure: {
      title: "Procedure",
      content: ["1.	Sterilize your field per your local guidelines.", "2.	Place the probe at the posterolateral aspect of the SCM in a sagittal orientation", "3.	Identify the sternocleidomastoid muscle (SCM at the level of the thyroid cartilage), the lateral aspect of the SCM with the levator scapulae muscle in view (deep) and the carotid artery.", "4.	Scan cranially along the SCM until the probe is approximately 3-5cm inferior to the ear and the greater auricular nerve is identified superficially.", "5.	Using an in-plane approach, direct your needle tip to be adjacent to the greater auricular nerve", "6.	After aspiration, inject 3-5 cc of desired anesthetic adjacent to the nerve." ]
    },
    pitfall: {
      title: "Pearls and Pitfall",
  ...
  },
  {
    ...
    indications: {
      title: "Indications",
      content: ["1.	Occipital scalp lacerations and abscess", "2.	Occipital Headaches"]
    },
    contraindications: [
      {
        title: "Please list any contraindications to the procedure.",
        content: ["1.	Allergy to local anesthetic", "2.	Infection or abscess over site of injection"]
      }
    ],
    positioning: {
      title: "Patient Positioning",
  ...
  },
  {
    ...
    indications: {
      title: "Indications",
      content: ["1.	Laceration repair of the lip and cheek", "2.	Abscess and burn management"]
    },
    contraindications: [
      {
        title: "Please list any contraindications to the procedure.",
        content: ["1.	Allergy to local anesthetic", "2.	Infection overInfection, abscess over site of injection", "3. injection through infected tissue","4. Pre-existing nerve injury"]
      }
    ],
    positioning: {
      title: "Patient Positioning",
    ...
    procedure: {
      title: "Procedure",
      content: ["Ultrasound guided approach", "1.	Sterilize your field per your local guidelines.","2.	The ultrasound probe is placed over the maxilla approximately 1cm below the lower orbit.", "3.	The infraorbital notch is identified as the indent in the hyperechoic, bony architecture of the maxilla.", "4.	The needle is typically advanced lateral to medial using an in-plane approach.", "5.	After negative aspiration, desired anesthetic is injected in the region of the infraorbital notch, under direct visualization.", "Anatomic (landmark) intraoral approach", "1.	The infraorbital foramen is palpated on the cutaneous surface below the orbital rim using the clinician’s nondominant hand.  The upper lip is simultaneously lifted using the nondominant thumb and index finger.  The infraorbital foramen is then palpated intraorally above the area of the lateral incisor.", "2.	The needle is inserted in the gingival mucosa and directed superiorly toward the foramen.", "3.	After negative aspiration desired anesthetic is deposited in the region of the foramen.", "Anatomic (landmark) extraoral approach", "1.	Sterilize your field per your local guidelines.", "2.	The infraorbital foramen is palpated.", "3.	The needle is inserted below the foramen and directed with a slight cephalic approach.", "4. Avoid direct penetration of the foramen.", "5.	After negative aspiration desired anesthetic in the region of the foramen."]
    },
    pitfall: {
      title: "Pearls and Pitfall",
    ...
    illustrations: [
      {caption: "Trigeminal Nerve Block", url: "https://advanced-analgesia.s3.amazonaws.com/content-graphics/Trigeminal+Nerve+Block.png"},
      {caption: "Trigeminal Nerve Block side view", url: "https://advanced-analgesia.s3.amazonaws.com/content-graphics/Trigeminal+Nerve+Block+side.png"}
    ],
    photos: [
      {caption: "Ultrasound anatomy", url: "https://advanced-analgesia.s3.amazonaws.com/content-graphics/Infraraorbital+Nerve+Block+Button-Ultrasound+anatomy.png"},
      {caption: "Probe placement 1", url: "https://advanced-analgesia.s3.amazonaws.com/content-graphics/Infraraorbital+Nerve+Block+Button-probe+placement-1.png"},
      {caption: "Probe placement 2", url: "https://advanced-analgesia.s3.amazonaws.com/content-graphics/Infraraorbital+Nerve+Block+Button-probe+placement-2.png"},
    ]
  },
    {
      ...
      indications: {
        title: "Indications",
        content: ["1.	Laceration repair of the lip and chin", "2.	Abscess and burn management"]
      },
      contraindications: [
        {
      ...
      procedure: {
        title: "Procedure",
        content: ["Ultrasound guided approach", "1.	Sterilize your field per your local guidelines.","2. The ultrasound probe is placed over the mandible approximately 1cm above the lower border, approximately 3 cm lateral of midline.", "3.	The mental foramen is identified as the indent in the bony architecture of the mandible.", "4.	The needle is typically advanced lateral to medial using an in-plane approach.", "5.	After negative aspiration, desired anesthetic is injected in the region of the mental foramen, under direct visualization.", "Anatomic (landmark) intraoral approach", "1. The mental foramen is palpated on the cutaneous surface on the lower mandible using the clinician’s nondominant hand.  The lower lip is simultaneously retracted using the nondominant thumb and index finger.  The foramen is then palpated intraorally above the area of the lower, first premolar.  ", "2.	The needle is inserted in the gingival mucosa and directed inferiorly toward the foramen.", "3. After negative aspiration, local anesthetic is deposited in the region of the foramen.", "Anatomic (landmark) extraoral approach", "1.	Sterilize your field per your local guidelines.", "2.	The infraorbital foramen is palpated (in line with the pupil and supraorbital/infraorbital foramen).", "3. The needle is inserted lateral to the foramen and directed medially.", "4. After negative aspiration, local anesthetic is deposited (after negative aspiration) in the region of the foramen."]
      },
      pitfall: {
        title: "Pearls and Pitfall",
...

  {
    ...
    indications: {
      title: "Indications",
      content: ["1. Laceration repair of the eyebrow and forehead", "2.	Abscess and burn management"]
    },
    contraindications: [
      {
        title: "Contraindications",
        content: ["1.	Allergy to local anesthetic", "2.	Infection overInfection, abscess over site of injection", "3. Suspected Globe injury","4. Pre-existing nerve injury"]
      }
    ],
    positioning: {
      title: "Patient Positioning",
    ...
    procedure: {
      title: "Procedure",
      content: ["Ultrasound guided approach", "1.	Sterilize your field per your local guidelines.","2.	With the patient’s eye closed, the ultrasound probe is placed over the medial aspect of the supraorbital rim.", "3.	The supraorbital notch is identified as the indent in the bone", "4.	The needle is typically advanced lateral to medial using an in-plane approach.", "5.	After negative aspiration, desired anesthetic is injected in the region of the mental foramen, under direct visualization.", "Anatomic (landmark) approach", "1.	Sterilize your field per your local guidelines.", "2.	The supraorbital foramen is palpated on the orbital rim approximately 2 cm from midline.", "3. The needle is advanced medially to lateral, superficially over the orbital rim.", "4. After negative aspiration, injection of local anesthetic is performed linearly as the needle is slowly removed back toward the entrance in the skin."]
    },
    pitfall: {
      title: "Pearls and Pitfall",
...
},
{
  ...
  indications: {
    title: "Indications",
    content: ["1.	Cervical and trapezius muscle spasm", "2.	Headache", "3. Toothache"]
  },
  contraindications: [
    {
      title: "Contraindications",
      content: ["1.	Overlying infection", "2.	Allergy to anesthetic"]
    }
  ],
  positioning: {
    title: "Patient Positioning",
  ...
  procedure: {
    title: "Procedure",
    content: ["1.)	Sterilize your field per your local guidelines.", "2.) Use probe to identify musculature to be injected as well as any vessels or nerves that need to be avoided. Be especially cautious of the cervical plexus. Make note of the depth of the pleura","3.)	Inject small amount of anesthetic under skin and advance needle under constant aspiration to desired depth. Can be done with or without use of real-time US.", "4.)	Inject 1-2cc of anesthetic. Withdraw needle almost to skin and re-direct, repeating in a fanning motion through muscle belly until a total of 10cc of anesthetic has been deposited"]
  },
  pitfall: {
    title: "Pearls and Pitfall",
